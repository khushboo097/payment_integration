<?php
	...
	$base_lang = 'en';
	$site_id = "a9dd54ac";
	$websiteUID = "cbce915966f50fd8517e89b43d1903ed59bc28c130fdc54c85ba2a19bf0d80cda66d0cb61a4f5651";
	$base_dir = dirname(__FILE__);
	$base_url = '/';
	$user_domain = 'payment-integration.000webhostapp.com';
	$home_page = '1';
	$mod_rewrite = true;
	$show_comments = false;
	$comment_callback = "http://us.zyro.com/comment_callback/";
	$user_key = "3NWk1jhJC3IlnuEJYWL/OFbtNgSy2BQgteoqLC210RY+aISgEg==";
	$user_hash = "a1864d3ed142844e";
